...
/*   Updated: 2019/02/28 21:40:22 by jblack-b         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_button	*ft_get_button_one(void)
{
	...
	new = (t_button){{750, 287}, 50, 50, ft_previous_fractal,
...
t_button	*ft_get_button_two(void)
{
	...
	new = (t_button){{1050, 287}, 50, 50, ft_next_fractal,
...
t_button	*ft_get_button_three(void)
{
	...
	new = (t_button){{750, 387}, 50, 50, ft_switch_color,
...
t_button	*ft_get_button_four(void)
{
	...
	new = (t_button){{750, 487}, 50, 50, ft_switch_smoothing,
		ft_get_figures(&((t_figure){ft_get_points(&((t_point){25, 25}),
	&((t_point){25, 25}), &((t_point){0, 50}),
	&((t_point){0, 0})), 0xFFFF00, ft_draw_cr}),
	&((t_figure){ft_get_points(&((t_point){0, 0}), &((t_point){0, 0}),
...
t_button	*ft_get_button_five(void)
{
	...
	new = (t_button){{750, 587}, 50, 50, ft_reset_view,
		ft_get_figures(&((t_figure){ft_get_points(&((t_point){25, 25}),
	&((t_point){25, 25}), &((t_point){0, 50}),
	&((t_point){0, 0})), 0xFFFF00, ft_draw_cr}),
	&((t_figure){ft_get_points(&((t_point){0, 0}), &((t_point){0, 0}),
